...
def load_contact(lst_contact):
    ...
    while True:
        line = f.readline() # 석준/7475/naver.com/창원
        if not line:
...
def get_menu():
    ...
    try:
        menu_num = int(input('메뉴입력: ')) # 숫자를 표한하는 문자열
    except Exception:
        print('예외발생!')
        menu_num = 0 # 메뉴와 관게없는 숫자
...
if __name__ == '__main__':
    ...
    # print('주소록 프로그램')
    # 3. 클래스 실행 - 객체를 생성
    # first = contact.Contact('황석준', '010-3002-7475', 'ghkdtjrwns12@naver.com', '창원')
    # print(first)
    run() # 제일 처음 실행되는 함수